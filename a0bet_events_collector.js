...
const connectDb = () => {
  return mongoose.connect("mongodb://127.0.0.1:27017/a0bet", {useNewUrlParser: true});
};
...
const scanBlocks = async (blocknumber) =>{
  ...
  try{
    ...
    console.log('last_scanned_blocknumber',last_scanned_blocknumber,'blocknumber',blocknumber);
